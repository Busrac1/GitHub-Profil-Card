...
//      getRepos(username)
//   } catch (err) {
//      createUserCard("Aradığınız kullanıcı bulunamadı...")
//   }
// }
...
//     //user bio varsa yazdır yoksa veya null sa boşluk yaz = ? işartei bu yüzden
//    const cardHTML=  `
//     <div class="card">
//     <img 
//     src=${user.avatar_url}
...
//                 ${user.public_repos} <strong>Repository</strong>
//             </li>
//          </ul>
//          <div class="respos" id="repos"></div>
//     </div>
// </div>
//  `
...
async function getUser(username) {
  try {
    ...
    if (err.response.status == 404) {
      createErrorCard('Üzgünüm aradığınız kullanıcı bulunamadı :(')
    }
  }
}
...
function addReposToCard(repos) {
  ...
  repos.slice(0, 3).forEach((repo) => {
    ...
    //tıklandığı zaman farklı sayfada açsın
